...
let fitbit_clientID="227MWT"
let fitbit_consumer_secret="c68cacd67a7009dfa97554a8027f0f2c"
let fitbit_redirect_uri="yabbitFitbit://"
...
class MSYFitBit: NSObject {
    ...
    func doOAuthFitbit2(completion: (success:Bool) -> Void) {
        ...
        oauthswift.authorizeWithCallbackURL( NSURL(string:"yabbitFitbit://")!, scope: "profile activity heartrate weight nutrition location", state:state, success: {
