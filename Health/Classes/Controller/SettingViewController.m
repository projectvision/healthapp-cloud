...
- (void)setUpdateFrequency
{
    ...
    UIAlertAction *firstAction = [UIAlertAction actionWithTitle:@"Every Minute"
                                                          style:UIAlertActionStyleDefault handler:^(UIAlertAction * action) {
                                                              NSLog(@"You pressed button one");
                                                             fireDateLabel.text=@"Every Minute";
                                                              [[NSUserDefaults standardUserDefaults] setObject:@"OEvery Minute" forKey:@"Frequency"];
    ...
    UIAlertAction *fourthAction = [UIAlertAction actionWithTitle:@"Once a Day"
                                                          style:UIAlertActionStyleDefault handler:^(UIAlertAction * action) {
                                                               fireDateLabel.text=@"Once a Day";
