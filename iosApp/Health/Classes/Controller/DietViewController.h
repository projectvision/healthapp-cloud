...
@property (weak, nonatomic) IBOutlet UIButton *combo11Btn;

@property (weak, nonatomic) IBOutlet UIButton *combo12Btn;

@property (weak, nonatomic) IBOutlet UIButton *combo13Btn;
///////////////////////////////////////////////
...
@property (weak, nonatomic) IBOutlet UITextField *combo11Txt;
@property (weak, nonatomic) IBOutlet UITextField *combo12Txt;
@property (weak, nonatomic) IBOutlet UITextField *combo13Txt;
...
@property (weak, nonatomic) IBOutlet TableViewWithBlock *combo11Table;
@property (weak, nonatomic) IBOutlet TableViewWithBlock *combo12Table;
@property (weak, nonatomic) IBOutlet TableViewWithBlock *combo13Table;
@property (weak, nonatomic) IBOutlet FUIButton *saveButton;
@property(strong) NSDictionary *diet;
